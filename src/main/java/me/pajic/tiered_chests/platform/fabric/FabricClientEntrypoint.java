...
public class FabricClientEntrypoint implements ClientModInitializer {
    ...
    public static ParticleResult getTierParticleColor(ChestTier tier, boolean isFancy) {
        ...
        if (isFancy) {
            ...
            return new ParticleResult(0xBBA685, true); // Subtle Standard Wood
        }
    }
    ...
    public static boolean shouldWash(Block block) {
        ...
        return tier != null && getTierParticleColor(tier, TieredChests.CONFIG.fancyChests.get()).wash();
    }
    ...
    public void onInitializeClient() {
        try {
            ...
            for (ChestTier tier : ChestTier.values()) {
                ...
                BlockColorRegistry.register(List.of(ctx -> {
                    return getTierParticleColor(tier, TieredChests.CONFIG.fancyChests.get()).color();
                }), chest, barrel);
            }
